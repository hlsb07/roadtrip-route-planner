...
class App {
    constructor() {
        ...
        // Callback für Route-Änderungen setzen
        this.routeManager.setOnRouteChangeCallback((places) => {
    ...
    bindEventListeners() {
        ...
        // ENTFERNT: Route selector change Event-Listener
        // Der routeManager.js handhabt das jetzt über den Callback
    }
